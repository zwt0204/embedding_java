package com.java.vec;

import com.java.vec.domain.WordEntry;
...
//		 learn.learnFile(new File("src/data/query.txt"));
//		 learn.saveModel(new File("src/data/javaSkip1"));
		String path = System.getProperty("user.dir") + "/word2vec/src/main/resources/data/";
		Word2VEC vec = new Word2VEC();
		vec.loadJavaModel(path+"javaSkip1");
